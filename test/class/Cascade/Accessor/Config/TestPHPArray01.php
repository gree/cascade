...
/**
 *  Cascade_Accessor_Config_TestPHPArray01
 */
final class Cascade_Accessor_Config_TestPHPArray01
    extends PHPUnit_Framework_TestCase
{
    // ----[ Class Constants ]----------------------------------------
    const SCHEMA_NAME = 'test#Accessor_Config_TestPHPArray01';
 ...
 *  データーフォーマット
 */
final class Cascade_Accessor_Config_TestPHPArray01_DataFormat
    extends Cascade_DB_Config_DataFormat
{
    ...
    // @var string  設定ファイル
    protected $config_file  = 'server.ini.php';
    // @var int    DB接続ドライバー種別
