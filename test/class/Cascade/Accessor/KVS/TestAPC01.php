...
/**
 *  Cascade_Accessor_KVS_TestAPC01
 */
final class Cascade_Accessor_KVS_TestAPC01
 ...
 *  データーフォーマット
 */
final class Cascade_Accessor_KVS_TestAPC01_DataFormat
    extends Cascade_DB_KVS_DataFormat
{
    ...
    protected $dsn          = NULL;
    // @var int    DB接続ドライバー種別
    protected $driver_type  = self::DRIVER_APC;
