...
/**
 *  Cascade_Accessor_KVS_TestFlare01
 */
final class Cascade_Accessor_KVS_TestFlare01
   ...
   // {{{ test_mget_01
    ...
    public function test_inc_01()
    {
        ...
        for ($i = 1; $i < $loop; $i++) {
            ...
            $this->assertEquals($data_01, $loop * $offset - $i * $offset);
        }
    }
    // }}}
};
 ...
 *  データーフォーマット
 */
final class Cascade_Accessor_KVS_TestFlare01_DataFormat
    extends Cascade_DB_KVS_DataFormat
{
    // ----[ Properties ]---------------------------------------------
    // @var string DSN
    protected $dsn          = 'gree(flare)://node/test';
    // @var int    DB接続ドライバー種別
