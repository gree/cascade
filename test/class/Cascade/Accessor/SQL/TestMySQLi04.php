...
/**
 *  Cascade_Accessor_SQL_TestMySQLi04
 */
final class Cascade_Accessor_SQL_TestMySQLi04
    extends PHPUnit_Framework_TestCase
{
    // ----[ Class Constants ]----------------------------------------
    const SCHEMA_NAME       = 'test#Accessor_SQL_TestMySQLi04';
    ...
    public function test_find_02()
    {
        ...
        $this->assertInternalType('array', $data_01[0]);
        $this->assertInternalType('array', $data_01[1]);
        $this->assertEquals(2, count($data_01), 2);
        $this->assertEquals($data_01, $data_02);
        $this->assertEquals($data_01, $data_03);
 ...
 *  データーフォーマット
 */
final class Cascade_Accessor_SQL_TestMySQLi04_DataFormat
