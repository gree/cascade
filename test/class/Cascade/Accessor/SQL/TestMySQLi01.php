...
/**
 *  Cascade_Accessor_SQL_TestMySQLi01
 */
final class Cascade_Accessor_SQL_TestMySQLi01
    extends PHPUnit_Framework_TestCase
{
    // ----[ Class Constants ]----------------------------------------
    const SCHEMA_NAME       = 'test#Accessor_SQL_TestMySQLi01';
        ...
        function test_mget_01(/* void */)
    {
        ...
        // -----------------------------
        $this->assertEquals(2,   $data_01[0][self::FIELD_NUM_ID]);
        $this->assertEquals(100, $data_01[0][self::FIELD_NUM_USER_ID]);
        $this->assertEquals(2,   $data_01[0][self::FIELD_NUM_ITEM_ID]);
        $this->assertEquals(2,   $data_01[0][self::FIELD_NUM_NUM]);
        $this->assertEquals(5,   $data_01[1][self::FIELD_NUM_ID]);
        $this->assertEquals(101, $data_01[1][self::FIELD_NUM_USER_ID]);
        $this->assertEquals(1,   $data_01[1][self::FIELD_NUM_ITEM_ID]);
        $this->assertEquals(3,   $data_01[1][self::FIELD_NUM_NUM]);
    }
    // }}}
    // {{{ test_find_first_01
    public /* void */
        function test_find_first_01(/* void */)
    {
        $accessor  = Cascade::getAccessor(self::SCHEMA_NAME);
    ...
    // {{{ test_to_value_01
    public /* void */
        function test_to_value_01(/* void */)
    {
        $accessor  = Cascade::getAccessor(self::SCHEMA_NAME);
        $stmt_name = 'sum_num';
    ...
    // {{{ test_to_execute_01
    public /* void */
        function test_to_execute_01(/* void */)
    {
        $accessor  = Cascade::getAccessor(self::SCHEMA_NAME);
        $stmt_name = 'inc_num';
    ...
    // {{{ test_to_execute_02
    public /* void */
        function test_to_execute_02(/* void */)
    {
        $accessor  = Cascade::getAccessor(self::SCHEMA_NAME);
        $stmt_name = 'inc_num';
 ...
 *  データーフォーマット
 */
final class Cascade_Accessor_SQL_TestMySQLi01_DataFormat
