...
/**
 *  Cascade_Accessor_SQL_TestMySQLi11
 */
final class Cascade_Accessor_SQL_TestMySQLi11
    extends PHPUnit_Framework_TestCase
{
    // ----[ Class Constants ]----------------------------------------
    const SCHEMA_NAME        = 'test#Accessor_SQL_TestMySQLi11';
    ...
    public function test_get_01()
    {
        ...
        $data_01  = $accessor->get($id, $hint = NULL, $use_master = TRUE);
        $data_02  = $accessor->get($id, $hint = NULL, $use_master = FALSE);
        $data_03  = $accessor->getEx('standby', $id, $hint = NULL, $use_master = FALSE);
    ...
    public function test_mget_01()
    {
        $ids      = array(2, 5);
        $accessor = Cascade::getAccessor(self::SCHEMA_NAME);
        $data_01  = $accessor->mget($ids, $hint = NULL, $use_master = TRUE);
        $data_02  = $accessor->mget($ids, $hint = NULL, $use_master = FALSE);
        $data_03  = $accessor->mgetEx('standby', $ids, $hint = NULL, $use_master = FALSE);
        ...
        // -----------------------------
        $this->assertEquals(2,   $data_01[2][self::FIELD_NAME_ID]);
        $this->assertEquals(100, $data_01[2][self::FIELD_NAME_USER_ID]);
        $this->assertEquals(2,   $data_01[2][self::FIELD_NAME_ITEM_ID]);
        $this->assertEquals(2,   $data_01[2][self::FIELD_NAME_NUM]);

        // -----------------------------
        $this->assertEquals(5,   $data_01[5][self::FIELD_NAME_ID]);
        $this->assertEquals(101, $data_01[5][self::FIELD_NAME_USER_ID]);
        $this->assertEquals(1,   $data_01[5][self::FIELD_NAME_ITEM_ID]);
        $this->assertEquals(3,   $data_01[5][self::FIELD_NAME_NUM]);
    }
    // }}}
    // {{{ test_find_first_01
 ...
 *  データーフォーマット
 */
final class Cascade_Accessor_SQL_TestMySQLi11_DataFormat
