...
/**
 *  Cascade_Accessor_SQL_TestMySQLi13
 */
final class Cascade_Accessor_SQL_TestMySQLi13
    extends PHPUnit_Framework_TestCase
{
    // ----[ Class Constants ]----------------------------------------
    const SCHEMA_NAME       = 'test#Accessor_SQL_TestMySQLi13';
    ...
    public function test_mget_01()
    {
        ...
        // -----------------------------
        $this->assertInternalType('array', $data_01);
        $this->assertInternalType('array', $data_01['100_3']);
        $this->assertInternalType('array', $data_01['104_4']);
        $this->assertEquals(2, count($data_01));
        $this->assertEquals($data_01, $data_02);
        $this->assertEquals($data_01, $data_03);

        // -----------------------------
        $this->assertEquals(100, $data_01['100_3'][self::FIELD_NAME_USER_ID]);
        $this->assertEquals(3,   $data_01['100_3'][self::FIELD_NAME_ITEM_ID]);
        $this->assertEquals(3,   $data_01['100_3'][self::FIELD_NAME_NUM]);

        // -----------------------------
        $this->assertEquals(104, $data_01['104_4'][self::FIELD_NAME_USER_ID]);
        $this->assertEquals(4,   $data_01['104_4'][self::FIELD_NAME_ITEM_ID]);
        $this->assertEquals(1,   $data_01['104_4'][self::FIELD_NAME_NUM]);
    }
    // }}}
    // {{{ test_find_first_01
 ...
 *  データーフォーマット
 */
final class Cascade_Accessor_SQL_TestMySQLi13_DataFormat
