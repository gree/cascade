...
/**
 *  Cascade_Accessor_SQL_TestMySQLi12
 */
final class Cascade_Accessor_SQL_TestMySQLi12
    extends PHPUnit_Framework_TestCase
{
    // ----[ Class Constants ]----------------------------------------
    const SCHEMA_NAME        = 'test#Accessor_SQL_TestMySQLi12';
    ...
    public function test_get_01()
    {
        ...
        $this->assertInternalType('array', $data_01[9]);
        $this->assertInternalType('array', $data_01[10]);
        $this->assertEquals(2, count($data_01));
        $this->assertEquals($data_01, $data_02);
        $this->assertEquals($data_01, $data_03);

        // -----------------------------
        $this->assertEquals(9,   $data_01[9][self::FIELD_NAME_ID]);
        $this->assertEquals(105, $data_01[9][self::FIELD_NAME_USER_ID]);
        $this->assertEquals(1,   $data_01[9][self::FIELD_NAME_ITEM_ID]);
        $this->assertEquals(3,   $data_01[9][self::FIELD_NAME_NUM]);

        // -----------------------------
        $this->assertEquals(10,  $data_01[10][self::FIELD_NAME_ID]);
        $this->assertEquals(105, $data_01[10][self::FIELD_NAME_USER_ID]);
        $this->assertEquals(5,   $data_01[10][self::FIELD_NAME_ITEM_ID]);
        $this->assertEquals(4,   $data_01[10][self::FIELD_NAME_NUM]);
    }
    // }}}
    // {{{ test_mget_01
    public function test_mget_01()
    {
        ...
        $this->assertEquals(count($data_01),          2);
        $this->assertEquals(count($data_01[102]),     1);
        $this->assertEquals(count($data_01[105]),     2);
        $this->assertEquals($data_01, $data_02);
        $this->assertEquals($data_01, $data_03);

        // -----------------------------
        $this->assertEquals(6,   $data_01[102][6][self::FIELD_NAME_ID]);
        $this->assertEquals(102, $data_01[102][6][self::FIELD_NAME_USER_ID]);
        $this->assertEquals(2,   $data_01[102][6][self::FIELD_NAME_ITEM_ID]);
        $this->assertEquals(1,   $data_01[102][6][self::FIELD_NAME_NUM]);

        // -----------------------------
        $this->assertEquals(9,   $data_01[105][9][self::FIELD_NAME_ID]);
        $this->assertEquals(105, $data_01[105][9][self::FIELD_NAME_USER_ID]);
        $this->assertEquals(1,   $data_01[105][9][self::FIELD_NAME_ITEM_ID]);
        $this->assertEquals(3,   $data_01[105][9][self::FIELD_NAME_NUM]);

        // -----------------------------
        $this->assertEquals(10,  $data_01[105][10][self::FIELD_NAME_ID]);
        $this->assertEquals(105, $data_01[105][10][self::FIELD_NAME_USER_ID]);
        $this->assertEquals(5,   $data_01[105][10][self::FIELD_NAME_ITEM_ID]);
        $this->assertEquals(4,   $data_01[105][10][self::FIELD_NAME_NUM]);
    }
    // }}}
    // {{{ test_find_first_01
    public function test_find_first_01()
    {
        ...
        // -----------------------------
        $this->assertEquals(5,   $data_01[self::FIELD_NAME_ID]);
    ...
    public function test_find_01()
    {
        ...
        // -----------------------------
        $this->assertInternalType('array', $data_01);
        $this->assertInternalType('array', $data_01[5]);
        $this->assertInternalType('array', $data_01[9]);
        $this->assertInternalType('array', $data_01[10]);
        $this->assertEquals(3, count($data_01), 3);
        $this->assertEquals($data_01, $data_02);
        $this->assertEquals($data_01, $data_03);

        // -----------------------------
        $row = array_shift($data_01);
        $this->assertEquals(5,   $row[self::FIELD_NAME_ID]);
        ...
        // -----------------------------
        $row = array_shift($data_01);
        $this->assertEquals(9,   $row[self::FIELD_NAME_ID]);
        ...
        // -----------------------------
        $row = array_shift($data_01);
        $this->assertEquals(10,  $row[self::FIELD_NAME_ID]);
        $this->assertEquals(105, $row[self::FIELD_NAME_USER_ID]);
 ...
 *  データーフォーマット
 */
final class Cascade_Accessor_SQL_TestMySQLi12_DataFormat
