...
/**
 *  Cascade_Tool_Command_Main
 *
 *  @author   Yoshinobu Kinugasa <kinugasa@gree.co.jp>
 *  @package  Cascade_Tool_Command
 */
final class Cascade_Tool_Command_Main
    extends Cascade_Tool_Command
{
    // ----[ Properties ]---------------------------------------------
    protected $config        = NULL;
    protected $command_entry = array(
        1 => 'Cascade_Tool_Command_AddDataFormat',
        2 => 'Cascade_Tool_Command_AddGateway',
    );
